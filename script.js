...
function initVanillaBadge() {
  ...
  const tplLink = '<a href="https://github.com/diyoriko/portfolio-template" target="_blank" rel="noopener" style="color:inherit;text-decoration:none;vertical-align:middle;opacity:.5">use as template</a>';
